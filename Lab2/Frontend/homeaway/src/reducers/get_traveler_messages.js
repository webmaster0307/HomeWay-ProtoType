...
const GetTravelerMessages = (state = {}, action) => {
    let newState = { ...state };
    if (action.type === "get_traveler_messages") {
    ...
    }else if (action.type === "get_traveler_messages_error") {
...
export default GetTravelerMessages;