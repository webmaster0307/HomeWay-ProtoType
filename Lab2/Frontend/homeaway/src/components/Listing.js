        ...
        <div className="col-md-4">
          ...
          <div className="col-md-8 px-3">
            <div id="cb" className="card-block px-3">
              <h4 style={{paddingBottom:"20px",textAlign:"left"}} className="card-title"><Link id="rtlink" to={`/detailsview/${this.props.data._id}/${this.props.search.start}/${this.props.search.end}/${this.props.search.guests}` }>{this.props.data.headline}</Link></h4>
