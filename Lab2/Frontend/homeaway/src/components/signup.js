...
import traveler_sign_up from '../actions/travelerSignUp.js';
    ...
    renderField(field) {
      ...
      onSubmit(values){
        console.log("sign up data",values);
          this.props.traveler_sign_up(values);
      }
...
<div id="main-cont-signup" className="main-div">
    ...
    <form id="Login" onSubmit={handleSubmit(this.onSubmit.bind(this))}>
      ...
      />
        ...
        function mapStateToProps(state){
            return{
                status:state.traveler_sign_up.status,
                message:state.traveler_sign_up.message
            };
        }
  ...
  validate,
  form: "NewTravelerSignUp"
})(connect(mapStateToProps, {traveler_sign_up})(SignUp));
