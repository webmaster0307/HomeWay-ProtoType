...
<button id="show-booking" className="btn btn-secondary"><Link to={`/fetchtravelers/${this.props.data.imageName}/${this.props.data.property_id}/${this.props.data.headline}/${this.props.data.propertytype}/${this.props.data.bathrooms}/${this.props.data.bedrooms}/${this.props.data.accomodates}/${this.props.data.rate}` }>Show Bookings</Link></button>
