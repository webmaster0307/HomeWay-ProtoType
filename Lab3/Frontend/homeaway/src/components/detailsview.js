...
import { book} from '../mutation/mutations';
...
console.log("in booking");
    ...
    var res1=this.props.book({
        variables: {
    start:this.state.start,
    end:this.state.end,
    guests:this.state.guests,
    traveler:cookie.load('traveler')
    ...
    if(res1.error){
        this.setState({
            bookingstatus:"This property has not been booked."
        })
    }
    this.setState({
        bookingstatus:"This property has been successfully booked."
